...
export const TABLES = {
  ...
  // Range fisiologico protocollo 6×5m: ~11-20s. P50=14.2s (media attesa per 8-9enni).
  // Tabella precedente (P100=20.0s, P50=28.0s) calibrata su popolazione sedentaria — non discriminava.
  // F = M (nessun dato normativo differenziato per questa fascia)
  shuttle_run_30m: {
