...
export const TESTS = [
...

  {
    ...
    variables: [
      ...
      { key: 'ANT_sx',       label: 'Anteriore SX (gamba SX in appoggio)', unit: 'cm' },
      { key: 'lunghezza_dx', label: 'Lunghezza arto DX (ASIS → mall. med.)', unit: 'cm' },
      { key: 'lunghezza_sx', label: 'Lunghezza arto SX (ASIS → mall. med.)', unit: 'cm' },
    ],
    ...
    guide: {
      ...
      equipment: [
        ...
        'Metro a nastro rigido per misurare la lunghezza degli arti',
      ],
      warmup: [
      ...
      protocol: [
        'LUNGHEZZA ARTO DX: misurare da ASIS (spina iliaca antero-superiore) al malleolo mediale destro in cm.',
        'LUNGHEZZA ARTO SX: ripetere la stessa misurazione per l\'arto sinistro.',
        'GAMBA DX IN APPOGGIO: l\'atleta si posiziona in equilibrio sul piede destro; con la punta del piede sinistro raggiunge il massimo lungo la direzione anteriore, poi ritorna.',
        'GAMBA SX IN APPOGGIO: ripetere con il piede sinistro come supporto, il piede destro raggiunge in avanti.',
        '3 prove valide per gamba. Registrare la MEDIA dei 3 valori (cm) per ciascuna gamba.',
        'Il sistema normalizza automaticamente ogni reach sulla propria lunghezza arto e ne calcola la media bilaterale.',
      ],
      notes: [
        'Differenza >4cm tra i due arti segnala asimmetria rilevante (rischio infortuni).',
        'Piedi nudi per uniformità tra sessioni.',
        'Più alto il valore percentuale = punteggio migliore.',
        'Soglia injury risk: score <70% indica deficit di stabilità dinamica.',
      ],
    },
  },
