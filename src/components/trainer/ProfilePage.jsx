...
export function ProfilePage({ user }) {
  return (
    <div className="px-6 py-8 max-w-lg">
      <p className="font-display text-[10px] text-white/30 tracking-[3px] mb-6">PROFILO TRAINER</p>
      ...
      <div className="rounded-2xl overflow-hidden"
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-5 py-4 cursor-pointer transition-all text-left border-none"
