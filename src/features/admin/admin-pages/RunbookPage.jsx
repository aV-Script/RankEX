        ...
        <div className="flex gap-1 shrink-0">
          {['pass', 'fail', 'skip'].map(s => (
            <button
              ...
              style={status === s
                ? { color: STATUS_META[s].color, borderColor: `color-mix(in srgb, ${STATUS_META[s].color} 40%, transparent)`, background: `color-mix(in srgb, ${STATUS_META[s].color} 9%, transparent)` }
