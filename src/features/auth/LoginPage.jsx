  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block w-px"
        style={{ background: 'linear-gradient(180deg, transparent, color-mix(in srgb, var(--rx-accent) 12%, transparent) 30%, color-mix(in srgb, var(--rx-accent) 12%, transparent) 70%, transparent)' }}
      />
      <div
