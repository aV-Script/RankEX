        ...
        return isHatTop ? (
          <div className="flex flex-col gap-3">
            <button
              ...
              style={{
                background: hatColor === null ? color + '12' : 'color-mix(in srgb, var(--rx-green) 4%, transparent)',
                border:     hatColor === null ? `2px solid ${color}` : '2px solid var(--rx-border)',
            ...
            >
              ...
              <div>
                ...
                <div className="font-display text-[7px]" style={{ color: 'var(--rx-text-muted)', marginTop: 2 }}>
        ...
        return (
          <div className="flex flex-col gap-3">
            <button
              ...
              className="flex items-center gap-3 cursor-pointer rounded-[5px] px-3 py-2"
              style={{
                background: jerseyColor === null ? color + '12' : 'color-mix(in srgb, var(--rx-green) 4%, transparent)',
                border:     jerseyColor === null ? `2px solid ${color}` : '2px solid var(--rx-border)',
                transition: 'all 0.15s ease',
              }}
            >
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: color, flexShrink: 0, boxShadow: `0 0 8px ${color}60` }} />
        ...
        return (
          <div className="flex flex-col gap-2">
            <input
              ...
              style={{ textAlign: 'center', fontSize: 24, fontWeight: 900, letterSpacing: '0.1em', padding: '12px' }}
            />
            <p className="font-display text-[8px] tracking-[1px] text-center" style={{ color: 'var(--rx-text-muted)' }}>
    ...
    <>
      ...
      <div className="hidden lg:flex" style={{ minHeight: 'calc(100svh - 80px)' }}>
        ...
        <div
          ...
          style={{ borderRight: '1px solid var(--rx-border)' }}
        >
          ...
          <div className="w-full px-7 pb-7 flex flex-col items-center gap-3 shrink-0">
            <div className="w-full h-px" style={{ background: 'var(--rx-border)' }} />
              ...
              <div key={sec.id} style={{
                ...
                >
                  <div className="shrink-0 flex items-center justify-center rounded-[4px]" style={{
                    width: 36, height: 36,
                    background: isOpen ? color + '18' : 'color-mix(in srgb, var(--rx-green) 6%, transparent)',
                    border:     isOpen ? `1px solid ${color}40` : '1px solid var(--rx-border)',
                    color:      isOpen ? color : 'color-mix(in srgb, var(--rx-green) 55%, rgba(255,255,255,0.3))',
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-display text-[7px] tracking-[2px] uppercase mb-0.5"
                      style={{ color: isOpen ? color + '65' : 'color-mix(in srgb, var(--rx-green) 40%, transparent)' }}>
                  ...
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                    stroke={isOpen ? color : 'color-mix(in srgb, var(--rx-green) 38%, transparent)'}
                ...
                {isOpen && (
                  <div className="px-4 pt-3 pb-4" style={{ borderTop: '1px solid var(--rx-border)' }}>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
          ...
          {/* Tasto azione — visibile quando il drawer è chiuso */}
          <div style={{ opacity: drawerOpen ? 0 : 1, transition: 'opacity 0.2s ease', pointerEvents: drawerOpen ? 'none' : 'auto' }}>
            <button
        ...
        <div style={{
          ...
          <div className="flex items-center gap-3 px-4 py-3 shrink-0"
            ...
            {openSection ? (
              <button
                ...
                style={{ width: 32, height: 32, borderRadius: 6, background: 'color-mix(in srgb, var(--rx-green) 7%, transparent)', border: '1px solid var(--rx-border)', color: 'color-mix(in srgb, var(--rx-green) 70%, rgba(255,255,255,0.5))' }}
              >
            ...
            {openSection ? (
              ...
              SECTIONS.map((sec, i) => (
                <button
                  ...
                  style={{ padding: '12px 16px', borderBottom: '1px solid var(--rx-border)' }}
                >
                  <div className="shrink-0 flex items-center justify-center rounded-[5px]"
                    style={{ width: 34, height: 34, background: 'color-mix(in srgb, var(--rx-green) 8%, transparent)', border: '1px solid var(--rx-border)', color: 'color-mix(in srgb, var(--rx-green) 60%, rgba(255,255,255,0.3))' }}>
                    {sec.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="font-display text-[6px] tracking-[2px] uppercase" style={{ color: 'color-mix(in srgb, var(--rx-green) 45%, transparent)' }}>
                      {String(i + 1).padStart(2, '0')}
                    </div>
                    <div className="font-display font-black uppercase truncate" style={{ fontSize: 10, color: 'var(--rx-text)' }}>
                      {sec.label}
                    </div>
                  </div>
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"
                    style={{ color: 'color-mix(in srgb, var(--rx-green) 40%, transparent)', flexShrink: 0 }}>
          ...
          <div className="px-4 py-3 shrink-0"
            style={{ borderTop: '1px solid var(--rx-border)', paddingBottom: 'calc(12px + env(safe-area-inset-bottom))' }}>
            <button
              onClick={handleSave}
              disabled={saving}
  ...
  return (
    <button onClick={onClick} className="flex flex-col items-center gap-1.5 cursor-pointer">
      <div style={{
        ...
        background: bg,
        border:     active ? `3px solid ${color}` : '3px solid var(--rx-border)',
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: '50%',
        background:   hex,
        border:       active ? '3px solid white' : '3px solid var(--rx-border)',
